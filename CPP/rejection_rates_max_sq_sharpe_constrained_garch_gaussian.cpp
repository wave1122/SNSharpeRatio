...
//	bws = 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70;
	...
	matrix<double> Omega1(3,3); /* unconditional covariance matrix */
	Omega1 = 0.20, 0.05, 0.05,
			 0.05, 0.20, 0.05,
		     0.05, 0.05, 0.20;
...
//	cout << mu1 << endl;
	...
	dir_name = "./Results/non_nested/cgarch/";
	...
	while (T <= 750) {
		...
		auto [asymp_REJF1, asymp_REJF5, asymp_REJF10, boot_REJF1, boot_REJF5, boot_REJF10, sn_REJF1, sn_REJF5, sn_REJF10, sn2_REJF1, sn2_REJF5, sn2_REJF10]
										 = Power::power_fovl<QS_kernel,
															Dgp::gen_dvech_trigarch<gsl_ran_gaussian>>(num_samples, /* number of random samples */
																										T, /* sample size */

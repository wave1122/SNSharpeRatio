...
//	bws = 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70;
	...
	matrix<double> mu1(4,1), mu2(4,1), mu3(4,1); /* means of traded factors and basis asset returns */
	mu1 = 0.5,
		 0.5,
		 0.5,
		 0.5;
	...
	matrix<double> mu4(2,1); /* means of non-traded factors */
	mu4 = 0.1,
		 -0.1;
	...
	matrix<double> C(2,2); /* Regression coefficients used to generate non-traded factors */
	C = 0.05, -0.05,
		0.01, -0.01;

	matrix<double> Omega1(4,4); /* unconditional covariance matrx of the innovations used to generate traded factors */
	Omega1 = 0.20, 0.05, 0.05, 0.05,
			 0.05, 0.20, 0.05, 0.05,
		     0.05, 0.05, 0.20, 0.05,
		     0.05, 0.05, 0.05, 0.20;

	matrix<double> Omega2(2,2); /* unconditional covariance matrix of the innovations used to generate non-traded factors */
	Omega2 = 0.20, 0.05,
			 0.05, 0.20;
	...
	dir_name = "./Results/non_traded/argarch/fovl=" + std::to_string(fovl) + "/";
	...
	while (T <= 750) {
		...
		auto [asymp_REJF1, asymp_REJF5, asymp_REJF10, boot_REJF1, boot_REJF5, boot_REJF10, sn_REJF1, sn_REJF5, sn_REJF10, sn2_REJF1, sn2_REJF5, sn2_REJF10]
											= Power::power_fovl_mimicking<QS_kernel,
												   Dgp::gen_dvech_margarch<gsl_ran_gaussian>>(num_samples, /* number of random samples */
																								...
																								mu1, /* means of traded factors and basis asset returns */
																								mu4, /* means of non-traded factors */
																								A, /* ARCH coefficients */
																								B, /* AR coefficients */
																								C, /* Regression coefficients used to generate non-traded factors */
																								Omega1, /* unconditional covariance matrx of the innovations used to generate traded factors */
																								Omega2, /* covariance matrix of the innovations used to generate non-traded factors */
		...
		std::tie(asymp_REJF1, asymp_REJF5, asymp_REJF10, boot_REJF1, boot_REJF5, boot_REJF10, sn_REJF1, sn_REJF5, sn_REJF10, sn2_REJF1, sn2_REJF5, sn2_REJF10)
										= Power::power_fovl_mimicking<QS_kernel,
												   Dgp::gen_dvech_margarch<gsl_ran_gaussian>>(num_samples, /* number of random samples */
																								...
																								num_boots, /* number of bootstrap repetitions */
																								nu, /* parameter of the error distribution */
																								mu2, /* means of traded factors and basis asset returns */
																								mu4, /* means of non-traded factors */
																								A, /* ARCH coefficients */
																								B, /* AR coefficients */
																								C, /* Regression coefficients used to generate non-traded factors */
		...
		std::tie(asymp_REJF1, asymp_REJF5, asymp_REJF10, boot_REJF1, boot_REJF5, boot_REJF10, sn_REJF1, sn_REJF5, sn_REJF10, sn2_REJF1, sn2_REJF5, sn2_REJF10)
											= Power::power_fovl_mimicking<QS_kernel,
												   Dgp::gen_dvech_margarch<gsl_ran_gaussian>>(num_samples, /* number of random samples */
																								...
																								num_boots, /* number of bootstrap repetitions */
																								nu, /* parameter of the error distribution */
																								mu3, /* means of traded factors and basis asset returns */
																								mu4, /* means of non-traded factors */
																								A, /* ARCH coefficients */
																								B, /* AR coefficients */
																								C, /* Regression coefficients used to generate non-traded factors */
